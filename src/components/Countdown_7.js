...
class Countdown_7 extends Component {
  state = {
    timerOn: false,
    timerStart: 0,
    timerTime: 0
  ...
  render() {
    ...
    return (
      <div className="Countdown">
        <div className="Countdown-header">Denis Broliquier</div>
        <img className="img-profil" src={require('./Broliquier.png')} />
