...
class Countdown_5 extends Component {
  state = {
    timerOn: false,
    timerStart: 0,
    timerTime: 0
  ...
  render() {
    ...
    return (
      <div className="Countdown">
        <div className="Countdown-header">Sandrine Runel</div>
        <img className="img-profil" src={require('./Runel.png')} />
