...
class Countdown_4 extends Component {
  state = {
    timerOn: false,
    timerStart: 0,
    timerTime: 0
  ...
  render() {
    ...
    return (
      <div className="Countdown">
        <div className="Countdown-header">Nathalie Perrin-Gilbert</div>
        <img className="img-profil" src={require('./Perringilbert.png')} />
