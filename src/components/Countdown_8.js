...
class Countdown_8 extends Component {
  state = {
    timerOn: false,
    timerStart: 0,
    timerTime: 0
  ...
  render() {
    ...
    return (
      <div className="Countdown">
        <div className="Countdown-header">Yann Cucherat</div>
        <img className="img-profil" src={require('./Cucherat.png')} />
